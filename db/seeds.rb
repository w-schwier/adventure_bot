...
As you frolic across a meadow you notice you can go one of two ways. Which way would you like to go?", result: "continue")
...
You start to loose track of how far you have come. As you round a corner you notice a great, mighty bear is blocking your path.
...
I shan't go into all the gory details, but lets just say you won't be adventuring again anytime soon!", result: 'fail')
